...
# Updated explicitly requested colors
color_n = '#4682B4'  # Steel Blue
color_y = '#FF8C00'  # Dark Orange
fraud_palette = {'N': color_n, 'Y': color_y}
...
# Updated to use the Steel Blue color specifically since there's no hue
sns.histplot(df['age_of_driver'], bins=30, kde=True, color=color_n)
